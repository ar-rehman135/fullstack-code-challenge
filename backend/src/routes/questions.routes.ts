...
class QuestionsRoute implements Route {
  public path = "/questions";
  public router = Router();
  private questionsController = new QuestionsController();
  ...
  private initializeRoutes() {
    ...
    this.router.get(
      `${this.path}/:id`,
      this.questionsController.getQuestionById
    );
    ...
    this.router.delete(
      `${this.path}/:id`,
      this.questionsController.deleteQuestion
    );
  }
}
