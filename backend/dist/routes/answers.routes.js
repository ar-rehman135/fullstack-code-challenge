...
const answers_controller_1 = tslib_1.__importDefault(require("@/controllers/answers.controller"));
/**
 * @swagger
 * tags:
 *   name: Answers
...
class AnswersRoute {
    constructor() {
        ...
        this.answersController = new answers_controller_1.default();
